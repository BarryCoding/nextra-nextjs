...
Next.js comes with a variety of built-in optimizations  
designed to improve your application's speed and [Core Web Vitals](https://web.dev/vitals/).  
...
Metadata helps search engines understand your content better (which can result in better SEO),  
and allows you to customize how your content is presented on social media,  
...
Learn more in the [API: Head](/next-page/api-reference/components/head) documentation.
...
For large applications, Next.js integrates with popular analytics and monitoring tools  
to help you understand how your application is performing.  
Learn more in the [Analytics](/docs/app/building-your-application/optimizing/analytics), [OpenTelemetry](/next-page/building-your-application/optimizing/open-telemetry) and [Instrumentation](/next-page/building-your-application/optimizing/instrumentation) guides.
