...
its JavaScript code runs and makes the page fully interactive (this process is called [hydration](https://react.dev/reference/react-dom/client/hydrateRoot) in React).
...
That means some parts of a page can be rendered entirely by clientside JavaScript.
