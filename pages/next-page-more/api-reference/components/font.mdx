...
| ------------------------------------------- | ------------- | ------------ | -------------------------- |
| [`src`](#src)                               | 🔴            | 🟢           | String or Array of Objects |
| [`weight`](#weight)                         | 🟢            | 🟢           | String or Array            |
...
export default function Page() {
  return (
    <div>
      ...
      <p className={sourceCodePro700.className}>Hello world using Source_Sans_3 font with weight 700</p>
