...
[theme.config.jsx](/nextra/docs-theme#create-docs-theme-config) file. It
...
You can refer to the [`useConfig`](/nextra/docs-theme/use-config) API section
  ...
  options={[
    ...
    [
      ...
      <>
        ...
        <a href='https://github.com/pacocoursey/next-themes#themeprovider' target='_blank'>
          next-themes
        </a>{' '}
        package.
      </>,
...
<OptionTable
  options={[
    ...
    ['primarySaturation', 'number | { dark: number; light: number }', 'The saturation of the primary theme color.'],
  ]}
/>
  ...
  <div className='flex h-6 items-center gap-2'>
    <input
      ...
      onChange={(e) => {
        ...
        document.documentElement.style.setProperty('--nextra-primary-hue', value)
      }}
    />
  ...
  <div className='flex h-6 items-center gap-2'>
    <input
      ...
      onChange={(e) => {
        ...
        e.target.nextSibling.textContent = value
        document.documentElement.style.setProperty('--nextra-primary-saturation', value)
      }}
    />
...
Project setting Show a button that links to your project’s homepage on the navbar. By default,
...
Chat setting Show a button that links to your project’s forum or other social media on the
navbar.
...
<OptionTable options={[['components', 'Record<string, React.FC>', 'Custom MDX components.']]} />

### Writing Direction

The default writing direction of the website.

<OptionTable options={[['direction', '"ltr" | "rtl"', 'Default writing direction.']]} />
...
<OptionTable options={[['main', 'React.FC<{ children: React.ReactNode }>', 'Component of main content.']]} />
...
<Callout type='info'>To disable it, you can set `feedback.content` to `null`.</Callout>
...
<Callout type='info'>To disable it, you can set `editLink.component` to `null`.</Callout>
